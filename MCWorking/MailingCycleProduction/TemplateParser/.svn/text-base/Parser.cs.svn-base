...
namespace TemplateParser {
    ...
    public class Parser
    {
        ...
        /// <summary>
        /// Sets Parameter List from Hashtable
        /// </summary>
        /// <param name="Variables">Parameter List as Hastable</param>
        ...
        private void ApplyModificator(ref string Value, string Modificator)
        {
            ...
            try
            {
                ...
                {
                    Modificators.Modificator objModificator = (Modificators.Modificator)Activator.CreateInstance(typeModificator);
