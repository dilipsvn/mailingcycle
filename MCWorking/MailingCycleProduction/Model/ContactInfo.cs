...
namespace Irmac.MailingCycle.Model
{
    ...
    /// <summary>
    /// Business Entity used to model Contacts.
    /// </summary>
    [Serializable]
    public class ContactInfo : BaseInfo
    {
        ...
        /// <param name="plotId">Plot to which Contact belongs</param>
        public ContactInfo(Int64 contactId, int scheduleNumber, string ownerFullName, int lot,
            ...
            DateTime createDate,DateTime lastModifyDate, int lastModifyBy,int plotId)
        {
