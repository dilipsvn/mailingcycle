<%@ Control Language="C#" AutoEventWireup="true" CodeFile="LeftNavMenuWebUserControl.ascx.cs" Inherits="WebUserControls_LeftNavMenuWebUserControl" %>
			    ...
			    <div id="left-nav">
                    <div class="vertical-menu">
	                    <div class="menu-item"><a id="a_Welcome" runat="server" href="~/Members/Welcome.aspx" runat="server">Dashboard</a></div>
	                    <div class="menu-item"><a id="a_FarmManagement" runat="server" href="~/Members/FarmManagement.aspx" runat="server">Farm Management </a></div>
	                    <div class="menu-item"><a id="a_UserManagement" runat="server" href="~/Members/SearchUsers.aspx" runat="server">User Management </a></div>
	                    <div class="menu-item"><a id="a_DesignManagement" runat="server" href="~/Members/DesignManagement.aspx" runat="server">Design Management </a></div>
                        <div class="menu-item"><a id="a_MessageManagement" runat="server" href="~/Members/MessageManagement.aspx" runat="server">Message Management </a></div>
                        <div class="menu-item"><a id="a_ScheduleManagement" runat="server" href="~/Members/ScheduleManagement.aspx" runat="server">Schedule Management </a></div>
                        <div class="menu-item"><a id="a_ProductCatalog" runat="server" href="~/Members/ProductCatalog.aspx" runat="server">Product Catalog </a></div>
                        <div class="menu-item"><a id="a_ProductManagement" runat="server" href="~/Members/ProductCatalog.aspx" runat="server">Product Management</a></div>
                        <div class="menu-item"><a id="a_OrderManagement" runat="server" href="~/Members/SearchOrders.aspx" runat="server">Order Management</a></div>
                        <div class="menu-item"><a id="a_ChangeRegistrationFee" runat="server" href="~/Members/ChangeRegistrationFee.aspx" runat="server">Change Registration Fee</a></div>
                        <div class="menu-item"><a id="a_ShoppingCart" runat="server" href="~/Members/ShoppingCart.aspx" runat="server">Shopping Cart </a></div>
                        <div class="menu-item"><a id="a_SearchFarmData" runat="server" href="~/Members/SearchFarmData.aspx" runat="server">Search Farm Data </a></div>
                        <div class="menu-item"><a id="a_BillingHistory" runat="server" href="~/Members/BillingHistory.aspx" runat="server">Billing History </a></div>
                        <div class="menu-item"><a id="a_SearchOrders" runat="server" href="~/Members/SearchOrders.aspx" runat="server">Search Orders</a></div>
                        <div class="menu-item"><a id="a_Inventory" runat="server" href="~/Members/Inventory.aspx" runat="server">Inventory</a></div>
                        <div class="menu-item"><a id="a_AuditTrail" runat="server" href="javascript: alert('Under development.'); //remove upto here~/Members/AuditTrail.aspx" runat="server">Audit Trail</a></div>
