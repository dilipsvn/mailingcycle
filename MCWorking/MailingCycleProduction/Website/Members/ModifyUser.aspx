<%@ Page Language="C#" MasterPageFile="~/Members/AgentMasterPage.master" AutoEventWireup="true" CodeFile="ModifyUser.aspx.cs" Inherits="ModifyUser" Title="Modify User" %>
        ...
        <table class="toptable" cellspacing="0" cellpadding="0" width="100%">
                                    ...
                                    <table border="0" cellspacing="2" cellpadding="1" width="100%">
                                        ...
                                        <tr>
                                            ...
                                            <td width="28%" class="t3" nowrap>
                                                ...
                                                <asp:TextBox ID="UserNameTextBox" runat="server" MaxLength="50" Width="150px" CausesValidation="True" enabled="false"></asp:TextBox>
                                            </td>
                                            <td width="22%" class="t2" nowrap>
                                                User Role:
                                            </td>
                                            <td width="28%" class="t3" nowrap>
                                                <asp:DropDownList ID="RoleDropDownList" runat="server" Enabled="false">
                                                <asp:ListItem Value=-1>&lt;Select a Role&gt;</asp:ListItem>
                                                </asp:DropDownList>
                                                <asp:RequiredFieldValidator id="RoleRequiredFieldValidator" runat="server" Display="none" ControlToValidate="RoleDropDownList" InitialValue="-1" ErrorMessage="Select a Role" SetFocusOnError="true"></asp:RequiredFieldValidator> 
                                            </td>
                                        </tr>
                                        <tr>
                                            <td width="22%" class="t2" nowrap>
                                        ...
                                        <tr>
                                            ...
                                            <td class="t3">
                                                <asp:TextBox ID="StatusTextBox" enabled="false" runat="server" MaxLength="256" Width="150px"></asp:TextBox>
                                            </td>
                                            <td class="t2" nowrap>&nbsp;
                                            </td>
                                            <td>&nbsp;
            ...
            <tr>
                <td align="center">
                    ...
                    <asp:Button CssClass="buttonfont" ID="CancelButton" CausesValidation="false" Text="Cancel" Width="80px"
