<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ScheduleEventsReport.aspx.cs"
    Inherits="Members_ScheduleEventsReport" %>
...
<head runat="server">
    <title>Mailing Cycle Schedule & Events Report</title>
</head>
