<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EventMailingLabelsReport.aspx.cs"
    Inherits="Members_EventMailingLabelsReport" %>
...
<head runat="server">
    <title>Mailing Cycle Mailing Labels Report</title>
</head>
