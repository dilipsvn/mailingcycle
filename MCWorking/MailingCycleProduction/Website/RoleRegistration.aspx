<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="RoleRegistration.aspx.cs" Inherits="RoleRegistration" Title="Mailing Cycle Agent Registration" %>
...
<asp:Content ID="Content8" ContentPlaceHolderID="ContentPlaceHolderPageTitleText"
    runat="server">
    Registration <span style="font-size: 0.8em">(Step 1 of 2)</span>
</asp:Content>
<asp:Content ID="Content7" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="right-content-mainsection">
        <table class="toptable" cellspacing="0" cellpadding="0" width="100%">
                                    ...
                                    <table border="0" cellspacing="2" cellpadding="1" width="100%">
                                        ...
                                        <tr>
                                            ...
                                            <td class="t3">
                                                ...
                                                <asp:RequiredFieldValidator id="RoleRequiredFieldValidator" runat="server" Display="none" ControlToValidate="RoleDropDownList" InitialValue="0" ErrorMessage="Select a Role" SetFocusOnError="true"></asp:RequiredFieldValidator> 
                                            </td>
                                        </tr>
                                        <tr>
                                            <td colspan="4">
            ...
            <tr>
                <td align="center">
                    <asp:Button CssClass="buttonfont" ID="MembershipButton" runat="server" OnClick="MembershipButton_Click" Text="Confirm Registration" Width="150px" />
                ...
                <td>
                    <table border="0" cellspacing="2" cellpadding="1" width="98%" align="center">
                        <tr>
                            ...
                            <td class="Notes">
                                If the account and personal details are as per your requirements; click the 'Cofirm Registration' button to complete your registration.</td>
                        </tr>
                    </table>
                </td>
            </tr>
