<%@ Page Language="C#" MasterPageFile="~/Members/AgentMasterPage.master" AutoEventWireup="true"
    CodeFile="ModifyPlot.aspx.cs" Inherits="Agent_ModifyPlot" Title="Mailing Cycle Edit Plot" %>
            ...
            <tr>
                <td height="30" class="tableheading">
                    <table cellspacing="0" cellpadding="0" width="100%">
                        <tr>
                            <td width="50%">Please modify plot details in the below form</td>
                ...
                <td>
                                ...
                                <fieldset>
                                    ...
                                    <table border="0" cellspacing="2" cellpadding="3" width="100%">
                                        ...
                                        <tr>
                                            ...
                                            <td class="t3">
                                                <asp:Label ID="LastModifiedOnLabel" runat="server" Text=""></asp:Label>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td colspan="2">
                    ...
                    <asp:Panel ID="Panel1" runat="server" Width="100%">
                        ...
                        <table border="0" cellspacing="0" cellpadding="0" width="98%" align="center">
                            ...
                            <tr>
                                <td align="center">
                                    <asp:Button ID="CreatePlotButton" cssClass="buttonfont" runat="server" Text="Save" OnClick="ModifyPlotButton_Click" Width="72px" />
                                    <img src="../Images/spacer.gif" width="10px" height="1" />
                                    <asp:Button ID="CancelPlotButton" cssClass="buttonfont" runat="server" Text="Cancel" OnClick="CancelPlotButton_Click" Width="72px" CausesValidation="False" />
                                </td>
                            </tr>
                        </table>
                    </asp:Panel> 
