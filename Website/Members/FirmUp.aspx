<%@ Page Language="C#" MasterPageFile="~/Members/AgentMasterPage.master" AutoEventWireup="true"
    CodeFile="FirmUp.aspx.cs" Inherits="Members_FirmUp" Title="Mailing Cycle Firm Up Plan" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
	...
	{
	    var textBox = "ctl00_ctl00_ContentPlaceHolder1_ContentPlaceHolder1_StartDateTextBox,ctl00_ctl00_ContentPlaceHolder1_ContentPlaceHolder1_StartDateHiddenField";
    ...
    <div class="right-content-mainsection">
        <table width="100%" cellspacing="0" class="toptable">
                ...
                <td>
                    <table border="0" cellspacing="0" cellpadding="0" width="98%" align="center">
                        <tr>
                            <td>
                                <fieldset>
                                    <legend class="LegendText">Schedule Details</legend>
            ...
            <tr>
                <td align="center">
                    <asp:Button ID="IAcceptButton" Text="I accept" CssClass="buttonfont" Width="80px" runat="server"
                        OnClick="IAcceptButton_Click" CausesValidation="true" />
                ...
                <td>
                    <table border="0" cellspacing="2" cellpadding="1" width="98%" align="center">
                        <tr>
                            ...
                            <td class="Notes">
                                Start date selection should fall in a practical time period, which is 2 weeks from the day Firm Up happens but within next 6 weeks.
                            </td>
                        </tr>
                        <tr>
                            <td valign="top">
                                <img width="12" height="8" src="../Images/arrow_orange.gif"></td>
                            <td class="Notes">
                                If the Mailing Plan is as per your requirements; enter a Start Date, read and accept the
                                Terms of Service (F8) by clicking the <i>'I accept'</i> button.
                            </td>
                        </tr>
                    </table>
                </td>
            ...
            <tr>
                <td>
                    <img src="../Images/spacer.gif" width="1" height="8" /><asp:HiddenField ID="FarmIdHiddenField" runat="server" Value="" /><asp:HiddenField ID="StartDateHiddenField" runat="server" Value="" /></td>
            </tr>
        </table>
    </div>
</asp:Content>
