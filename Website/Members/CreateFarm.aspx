<%@ Page Language="C#" MasterPageFile="~/Members/AgentMasterPage.master" AutoEventWireup="true"
    CodeFile="CreateFarm.aspx.cs" Inherits="CreateFarm" Title="Mailing Cycle Add Farm" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:Panel ID="Panel1" runat="server" Height="450px" Width="100%">
        <table class="toptable" cellspacing="0" cellpadding="0" width="100%">
            <tr>
                <td height="30" class="tableheading">
                    <table cellspacing="0" cellpadding="0" width="100%">
                        <tr>
                            <td width="50%">Please fill farm details in the below form</td>
            ...
            <tr>
                <td align="center">
                    <asp:Button ID="CreateFarmButton" cssClass="buttonfont" runat="server" Text="Save" OnClick="CreateFarmButton_Click" Width="72px" />
                    <img src="../Images/spacer.gif" width="10px" height="1" />
                    <input class="buttonfont" type="button" value="Cancel" style="width: 80px" onclick="javascript:location.href='FarmManagement.aspx'" id="CancelButton" />
                </td>
            </tr>
            <tr>
                <td>
