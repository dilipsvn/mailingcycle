                    ...
                    <tr>
                        ...
                        <td class="t3">
                            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                <ContentTemplate>
                            <asp:DropDownList ID="BillingStateDropDownList" runat="server"  OnSelectedIndexChanged="BillingStateDropDownList_SelectedIndexChanged" AutoPostBack="True" ></asp:DropDownList><asp:RequiredFieldValidator ID="BillingStateDropDownListRFValidator" runat="server" SetFocusOnError="true" ControlToValidate="billingStateDropDownList"
